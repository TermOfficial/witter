    ...
    <div id="content">
        <div class="wrapper">
            ...
            <div class="customtopLeft">
                <big><big><big>About</big></big></big><br>
                Witter is made by 3 developers<br>
                - zulc22 [JS]<br>
                - ezist [JS]<br>
                - chief bazinga [Backend]<br><br>
                We use MySQLI. We don't store IPs since people can just use VPNs to bypass bans.<br>
                We hash your passwords with BCrypt.<br><br>
